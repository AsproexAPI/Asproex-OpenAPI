...
The base url of asproex open API is: https://www.asproex.com/openapi
...
In the `symbols` field, the endpoint will return information on current actively trading cryptos on asproex . You can ignore this section.

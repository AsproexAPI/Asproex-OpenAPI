package io.asproex.api.client.constant;

import org.apache.commons.lang3.builder.ToStringStyle;

public class AsproexConstants {

    public static final long DEFAULT_RECEIVING_WINDOW = 5_000L;

    public static final String API_BASE_URL = "https://api.asproex.com/";

    /**
     * Streaming API base URL.
     */
    public static final String WS_API_BASE_URL = "wss://wsapi.asproex.com/openapi/quote/ws/v1";

    public static final String WS_API_USER_URL = "wss://wsapi.asproex.com/openapi/ws/";

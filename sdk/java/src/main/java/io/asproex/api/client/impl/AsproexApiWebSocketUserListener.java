...
import io.asproex.api.client.domain.account.SocketAccount;
import io.asproex.api.client.domain.account.SocketOrder;
 ...
 */
public class AsproexApiWebSocketUserListener<T> extends WebSocketListener {
    ...
    public AsproexApiWebSocketUserListener(AsproexApiCallback<T> callback) {
    ...
    public void onMessage(WebSocket webSocket, String text) {
        ...
        try {
            ...
            if (jsonNode.isArray()) {
                ...
                JsonNode pingNode = jsonNode.get(AsproexConstants.PING_MSG_KEY);
                if (pingNode != null) {
                    pingTime = pingNode.asLong();
                    pingMap.put(AsproexConstants.PONG_MSG_KEY, System.currentTimeMillis());

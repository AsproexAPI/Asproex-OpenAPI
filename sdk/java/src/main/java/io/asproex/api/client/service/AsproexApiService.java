package io.asproex.api.client.service;
...
import io.asproex.api.client.domain.general.ServerTime;
...
/**
 * Asproex's REST API URL mappings and endpoint security configuration.
 */
public interface AsproexApiService {

    // General endpoints
    @GET("/openapi/quote/v1/ping")
    @Headers(AsproexConstants.ENDPOINT_SECURITY_TYPE_APIKEY_HEADER)
    Call<Void> ping();
    ...
    @Headers(AsproexConstants.ENDPOINT_SECURITY_TYPE_SIGNED_HEADER)

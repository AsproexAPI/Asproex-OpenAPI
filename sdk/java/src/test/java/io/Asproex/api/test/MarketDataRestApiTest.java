...
import io.asproex.api.client.domain.market.BookTicker;
import io.asproex.api.client.domain.market.Candlestick;
import io.asproex.api.client.domain.market.CandlestickInterval;
import io.asproex.api.client.domain.market.Index;
import io.asproex.api.client.domain.market.OrderBook;
import io.asproex.api.client.domain.market.TickerPrice;
import io.asproex.api.client.domain.market.TickerStatistics;
import io.asproex.api.client.domain.market.TradeHistoryItem;
